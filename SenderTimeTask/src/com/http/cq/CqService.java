 ...
 */
@Component
public class CqService extends AbstractBaseService {
	...
	public void handler(SystemEnum systemEnum) {
		try {
			...
			for (EquipmentProjectVo project : list) {
				...
				String info = CqUtil.toJsonObject(v).toString();
				log.info(info);
				Map<String, String> map =  CqUtil.getHeaderMap();
	...
	public static void main(String[] args) throws JSONException, ClientProtocolException, IOException {
		...
		object = CqUtil.toJsonObject(v);
		System.out.println(object);
		CommonUtil.doHttpPost2("http://58.17.245.161:6005/api/environment-D/data", object.toString(), CqUtil.getHeaderMap(),log);
	}
