...
public class SaveYCJCService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://211.142.202.28:7013/nysanitate/services/SaveYCJCService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SaveYCJCService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://211.142.202.28:7013/nysanitate/services/SaveYCJCService?wsdl");
        }
        WSDL_LOCATION = url;
    }
