...
public class SaveYCJCService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://221.176.156.141:8686/kfsanitate/services/SaveYCJCService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SaveYCJCService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://221.176.156.141:8686/kfsanitate/services/SaveYCJCService?wsdl");
        }
        WSDL_LOCATION = url;
    }
