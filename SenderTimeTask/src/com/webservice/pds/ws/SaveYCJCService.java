...
@WebServiceClient(name = "SaveYCJCService", 
                  wsdlLocation = "http://202.110.92.136:8686/pdssanitate/services/SaveYCJCService?wsdl",
...
public class SaveYCJCService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://202.110.92.136:8686/pdssanitate/services/SaveYCJCService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SaveYCJCService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://202.110.92.136:8686/pdssanitate/services/SaveYCJCService?wsdl");
        }
        WSDL_LOCATION = url;
    }
